...
In deep sleep, with this library, power consumption drops to **147 µA** if you have defined `HELTEC_POWER_BUTTON`, or **24 µA** if you only use the timer to wake up.
